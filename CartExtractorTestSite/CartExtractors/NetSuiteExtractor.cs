...
{
    public sealed class NetSuiteExtractor : CartExtractor
    {
        public NetSuiteExtractor(SiteRules rules)
            : base(rules)
        {
            ...
            if (!HasCredentials && BoostLog.Instance != null)
                BoostLog.Instance.WriteEntry(EventLogEntryType.Error, "Invalid NetSuite API Credentials", status, Alias);
            else
        ...
        string queryResult;
        public int maxCallsPerSecond = 2; // NetSuite limits us to 2 calls into their API per second
        ...
        private void SetGetParameters(DataGroup group, string groupIdentifier, int pageSize, string minModSpecifier, string maxModSpecifier, ref string startdate, ref string enddate, ref string rowrange, out int firstPage, out int rowStart, out int lastPage, out int rowEnd, out string taretGetString)
        {
            ...
            {
                // add one day to enddate because NetSuite date range is not inclusive
        ...
        public void GetEntity(DataGroup group, JObject entity)
        {
            switch (group)
            {
                ...
                case DataGroup.Inventory:
                    ...
                    //  "brand": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/brands/17.json",
                    //    "resource": "/brands/17"
                    //  },
                    //  "images": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/images.json",
                    //    "resource": "/products/32/images"
                    //  },
                    //  "discount_rules": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/discountrules.json",
                    //    "resource": "/products/32/discountrules"
                    //  },
                    //  "configurable_fields": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/configurablefields.json",
                    //    "resource": "/products/32/configurablefields"
                    //  },
                    //  "custom_fields": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/customfields.json",
                    //    "resource": "/products/32/customfields"
                    //  },
                    //  "videos": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/videos.json",
                    //    "resource": "/products/32/videos"
                    //  },
                    //  "skus": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/skus.json",
                    //    "resource": "/products/32/skus"
                    //  },
                    //  "rules": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/rules.json",
                    //    "resource": "/products/32/rules"
                    //  },
                    //  "option_set": null,
                    //  "options": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/products/32/options.json",
                    //    "resource": "/products/32/options"
                    //  },
                    //  "tax_class": {
                    //    "url": "https://store-et7xe3pz.myNetSuite.com/api/v2/taxclasses/0.json",
                ...
                case DataGroup.Sales:
                    ...
                    //    },
                    //    "products": {
                    //      "url": "https://store-bwvr466.myNetSuite.com/api/v2/orders/100/products.json",
                    //      "resource": "/orders/100/products"
                    //    },
                    //    "shipping_addresses": {
                    //      "url": "https://store-bwvr466.myNetSuite.com/api/v2/orders/100/shippingaddresses.json",
                    //      "resource": "/orders/100/shippingaddresses"
                    //    },
                    //    "coupons": {
                    //      "url": "https://store-bwvr466.myNetSuite.com/api/v2/orders/100/coupons.json",
                ...
                case DataGroup.Customers:
                    ...
                    //  "tax_exempt_category": "",
                    //  "addresses": {
                    //    "url": "https://store-bwvr466.myNetSuite.com/api/v2/customers/1/addresses.json",
                ...
                case DataGroup.Custom:
                    ...
                    break;
                case DataGroup.Options:
                    //    "url": "https://store-bwvr466.myNetSuite.com/api/v2/products/rules.json",
                    //{
                    //      "id":120,
                    //      "product_id":61
                    ...
                    break;
                case DataGroup.OrderProducts:
                    //    "url": "https://store-bwvr466.myNetSuite.com/api/v2/orders/products.json",
                    //{
                    //  "id": 16,
                    //  "order_id": 115,
                    //  "product_id": 0,
                    ...
                    break;
                case DataGroup.CustomerAddresses:
                    //    "url": "https://store-bwvr466.myNetSuite.com/api/v2/customers/addresses.json",
                    //  {
                    //  "id": 1,
                    //  "customer_id": 10,
                    //  "first_name": "Trisha",
