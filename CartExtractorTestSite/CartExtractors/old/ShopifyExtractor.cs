...
namespace _4_Tell.CartExtractors
{
 public sealed class ShopifyExtractor : CartExtractor
    {
        private static string ShopifyConsumerKey = "6fd32aae0337b9301508e826183539ad";
        private static string ShopifyConsumerSecret = "5243cd245ff5336af6fb60d0190ff7d9";
        private string _shopName = "";
        private string _userName = ""; 
        private string _apiKey = "";
        private ShopifyAdaptor adaptor = null;
            ...
            : base(rules)
        {
            ...
            adaptor = new ShopifyAdaptor(_apiKey, _userName, Rules.ApiUrl, this);
        }
    ...
    {       
        ...
        string queryResult;
        ShopifyExtractor extractor = null;
        ...
        public void AuthorizeMe()
        {
            //ShopifyAuthorizationState authState = new ShopifyAuthorizationState();
            //authState.ShopName = shopname.Replace(".myshopify.com", String.Empty);
            //authState.AccessToken = code;
        ...
        {           
            ...
            int entityCount = 0;
            queryResult = extractor.GetQueryResponse(group, countUrl, maxCallsPerSecond);
        ...
        {   
            ...
            if (lastPage >= firstPage)
            {
                for (int i = firstPage; i <= lastPage; i++)
                {
                    ...
                    queryResult = extractor.GetQueryResponse(group, taretGetString + "page=" + (i + 1).ToString(), maxCallsPerSecond);
